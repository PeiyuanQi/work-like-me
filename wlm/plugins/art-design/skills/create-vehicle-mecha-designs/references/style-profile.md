...
```text
Avoid random greebles, impossible joints, floating parts, uniform panel density, tiny unreadable wheels or cockpits, excessive neon, and weapon attachments without structural support.
```
