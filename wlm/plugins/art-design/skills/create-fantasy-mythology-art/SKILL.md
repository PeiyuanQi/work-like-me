---
name: create-fantasy-mythology-art
description: Create or art-direct fantasy, mythology, medieval, magical, spiritual, and folkloric imagery. Use when the user wants grounded fantasy key art, mythic characters, magical environments, ritual scenes, legends, creatures, or an image-generation prompt where cultural logic, material history, and restrained supernatural effects matter.
---

# Create Fantasy and Mythology Art
