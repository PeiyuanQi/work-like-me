---
name: create-graphic-ui-motion-art
description: Create or art-direct graphic systems, icon families, game UI art, fictional interfaces, emblems, banners, visual effects frames, and motion-design keyframes. Use when the user needs a coherent system rather than a single illustration, including reusable shapes, state variations, hierarchy, modular components, or image-generation prompts for polished interface and graphic assets.
---

# Create Graphic, UI, and Motion Art
