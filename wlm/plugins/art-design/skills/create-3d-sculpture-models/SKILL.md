...
description: Plan or art-direct 3D sculpture, character models, hard-surface models, props, vehicles, materials, grooming, texturing, and presentation renders. Use when the user wants a production-ready 3D workflow, sculpt brief, modeling breakdown, texture/render direction, turnaround, portfolio presentation, or image-generation reference for a model that must work beyond one camera angle.
---
