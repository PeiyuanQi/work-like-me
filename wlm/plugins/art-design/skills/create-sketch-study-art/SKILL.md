---
name: create-sketch-study-art
description: Create or art-direct sketches, studies, anatomy practice, value studies, color studies, gesture work, and exploratory drawings. Use when the user wants an image to feel observational, process-led, energetic, unfinished in a deliberate way, or focused on learning one visual problem rather than producing polished key art.
---

# Create Sketch and Study Art
