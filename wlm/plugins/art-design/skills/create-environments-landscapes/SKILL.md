---
name: create-environments-landscapes
description: Create or art-direct environments, landscapes, natural vistas, settlements, ruins, weather studies, and location key art. Use when the user wants a place-first image, environmental concept, matte-painting direction, landscape study, game location, or image-generation prompt with clear depth, scale, atmosphere, and navigable spatial storytelling.
---

# Create Environments and Landscapes
