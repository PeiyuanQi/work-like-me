---
name: create-weapons-props-objects
description: Create or art-direct weapons, props, equipment, artifacts, gadgets, armor components, and hero objects. Use when the user needs an isolated object, prop sheet, orthographic design, game item, production concept, icon-ready silhouette, or image-generation prompt with functional construction and material storytelling.
---

# Create Weapons, Props, and Objects
