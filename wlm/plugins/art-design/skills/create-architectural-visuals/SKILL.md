---
name: create-architectural-visuals
description: Create or art-direct architecture, interiors, built environments, spatial concepts, and atmospheric architectural visualization. Use when the user wants an exterior, interior, temple, house, civic space, settlement, spatial keyframe, or environment image where circulation, structure, human scale, and lived-in detail matter.
---

# Create Architectural Visuals
