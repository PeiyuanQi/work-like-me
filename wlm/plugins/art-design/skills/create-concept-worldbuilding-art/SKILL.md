---
name: create-concept-worldbuilding-art
description: Create or art-direct concept art, visual development, worldbuilding, production keyframes, design explorations, and coherent visual systems. Use when the user needs to answer a design question, explore alternatives, establish a world, connect narrative and production constraints, or create image-generation prompts that produce useful decisions rather than isolated pretty pictures.
---

# Create Concept Art and Worldbuilding
